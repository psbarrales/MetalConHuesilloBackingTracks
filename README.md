...
- `PATCH /songs/custom/{slug}`: edita metadata, portada, stems o recibe `raw` para volver a separar en background.
- `DELETE /songs/custom/{slug}`: elimina una canción custom y sus archivos.
